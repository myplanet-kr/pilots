...
void main() async {
  ...
  await client.connectUser(User(id: 'luke_moon', name: 'luke'),
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoibHVrZV9tb29uIn0.PaHTKmkcAI_zHWWhCJDns5hpw1wh5RYxjCv-367Mpoo');
